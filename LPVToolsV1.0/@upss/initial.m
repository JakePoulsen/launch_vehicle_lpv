...
% INITIAL  Pointwise initial condition response for UPSS objects
%
% INITIAL(SYS,X0) plots the undriven response of the UPSS SYS starting from 
% the initial condition X0. The initial condition response is plotted for 
% each system in the domain of SYS.
%
...
if nout >0                    
    ...
    if flg
        ...
        % Replace TEND with a time vector.
        varargin{3} = Tnew;  
