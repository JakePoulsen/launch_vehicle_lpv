...
% LOOPSENS  Feedback loop sensitivity functions for UPSS objects
%  
% LOOPTRANSFER = LOOPSENS(P,C) constructs the loop transfer functions for
% the multivariable feedback loop consisting of the UPSS C in negative 
% feedback with the UPSS P, as shown in the diagram below. The loop 
% transfer functions are computed at each point in the combined domains of 
% P and C.  
%              
%     ----->0------>[ P ]----------+----> 
%           |-                     |
