...
% LPVSAMPLE   Sample a UPSS object
%
...
% domain of SYS. The output S is an array of uncertain state-space systems  
% (USS) of size: [size(SYS), N].
%
...
% 
%   % EXAMPLE: (CUT/PASTE)
%   % Sample a 1-by-1 UPSS object
%   a = pgrid('a',1:5);
%   M = ss(-a,2,4,0)*ureal('u',5);
