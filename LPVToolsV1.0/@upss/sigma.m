...
% SIGMA   Pointwise singular value plot for UPSS objects
%
% SIGMA(SYS)  produces a family of singular value plot of the frequency 
% responses of the UPSS SYS at each point in the domain of SYS.
%
