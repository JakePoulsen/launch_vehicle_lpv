...
% STEP  Pointwise step response for UPSS objects
%
% STEP(SYS) plots a family of step responses for SYS at each point in the 
% domain of SYS. The family of step responses is obtained by evaluating the
% step response for different values of the uncertainty.
%
