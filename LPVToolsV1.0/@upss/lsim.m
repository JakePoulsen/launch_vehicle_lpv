...
% LSIM  Pointwise time-domain response of UPSS objects to arbitrary inputs
%
% LSIM(SYS,U,T) plots the time-domain response of the UPSS SYS  
% to the input signal described by U and T. The nominal value (no uncertainty) 
% of SYS is used. SYS is an NY-by-NU system with NX states. T is a NT-by-1  
% column vector which describes the time vector for the simulation. U is  
% a NT-by-NU matrix which describes the trajectory of each of the NU inputs 
% to SYS. 
%
