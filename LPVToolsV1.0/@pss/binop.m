...
% BINOP Binary operations for a PSS
% 
% BINOP is a utility function that handles binary operations (e.g. times,
% ldivide, lft, etc.) on PSSs. The user should not call BINOP directly. 
...
% GJB 29Jan12  Modified to handle uncertain objects
...
Cdata = ss(zeros( [size(C1) szA(3:end)] ));
Cdata(:,:,1) = C1;
...
C = pss(Cdata,Aext.DomainPrivate);
