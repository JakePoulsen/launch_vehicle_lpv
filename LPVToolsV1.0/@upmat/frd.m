...
% FRD  Call UPFRD constructor
% 
% SYS = FRD(RESPONSE,FREQS) creates a UPFRD, a uncertain parameter-varying 
%   frequency response data model defined on an N-dimensional rectangular 
%   grid. FREQS is a Nf-by-1 DOUBLE of frequency values. RESPONSE is a PMAT
...
%
% SYS = FRD(RESPONSE,FREQS,TS) creates a discrete time UPFRD model with 
