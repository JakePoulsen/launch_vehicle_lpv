...
% SIZE   Size of a UPMAT object.
%
% For an M-by-N UPMAT A with P independent variables and D array dimensions, 
...
nout = nargout;
if nout==2
    % Direct call to csize with nout = 2 puts the product of the column
