...
% CTRANSPOSE  Complex conjugate transpose for PFRD objects.
%
% B=CTRANSPOSE(A) returns the complex conjugate transpose of A at
% each point in the domain of A.
%
% For continuous-time PFRD, if A has the transfer function H(s) at a point 
% in the domain then B is the system with transfer function H(-s).'
%
% For discrete-time PFRD, if A has the transfer function H(z) at a point 
