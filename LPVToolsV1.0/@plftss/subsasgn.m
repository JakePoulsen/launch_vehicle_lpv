...
% SUBSASGN  Subscripted assignment for PLFTSS objects.
%
    ...
    case '.'
        try
            ...
            if isempty(idx)                
                ...
                idx2 = find( strncmpi(N,{'SamplingGrid'; 'Blocks'},length(N)) );
                if ~isempty(idx2)
                ...
                switch idx
                    ...
                    case 3
                        error(['You cannot set the read-only ' ...
                            'property ''NominalValue'' of a plftss.'])
                end
            end
